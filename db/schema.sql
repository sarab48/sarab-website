...
-- WhatsApp Cloud API ingestion (2026-07-23): every message reaching /api/wa-webhook,
-- verbatim; new contacts auto-become استفسار bookings (see functions/api/wa-webhook.js).
